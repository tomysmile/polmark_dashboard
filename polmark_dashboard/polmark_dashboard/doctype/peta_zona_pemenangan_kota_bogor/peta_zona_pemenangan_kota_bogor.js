...
function initializeLeafletMap(frmInstance) {
	...
	function loadMap(region_code, currentLevel, parentLevel, renderLevel) {
		...
		const url = `polmark_dashboard.api.geojson.get_geojson_data_by_region?region=Kota Bogor&region_level=${mapRenderLevel}&region_code=${region_code}`;
	...
	function createDataTooltip() {
		...
		<table id="tooltip-table" style="border-collapse: collapse; width: 100%;">
			<tbody>
				...
				<tr>
					<th style="text-align: left; padding: 5px; border-bottom: 1px solid #ccc;">DPTHP</th>
					<td id="jml-dpthp" style="padding: 5px; border-bottom: 1px solid #ccc;"></td>
				</tr>
				<tr>
					<th style="text-align: left; padding: 5px; border-bottom: 1px solid #ccc;">DPTHP /KK</th>
					<td id="jml-dpthp-perkk" style="padding: 5px; border-bottom: 1px solid #ccc;"></td>
				</tr>
				<tr>
					<th style="text-align: left; padding: 5px; border-bottom: 1px solid #ccc;">DPTHP Perempuan</th>
	...
	function showDataTooltip(data) {
		...
		document.getElementById("jml-dpthp-perkk").textContent = data.jml_dpthp2_perkk;
	...
	function fetchTableData(level, region) {
		const url = `polmark_dashboard.api.tabular.get_tabular_data?region=Kota Bogor&region_level=${mapRenderLevel}&region_code=${region}`;
